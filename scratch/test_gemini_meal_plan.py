...
- Budget Tier: medium
- Budget Limit: 1000 EGP/month (~250 EGP/week)
  ...
  "meals": {
    "sunday": {
      "breakfast": {
        ...
        "description_en": "Healthy oats",
        "description_ar": "شوفان صحي",
        "ingredients": [
          {
            "name_en": "Oats",
            "name_ar": "شوفان",
...
t0 = time.time()
print("Sending request to Gemini with thinkingBudget: 0...")
...
try:
    with urllib.request.urlopen(req, timeout=60) as resp:
        ...
        print(f"Parsed days: {list(parsed.get('meals', {}).keys())}")
